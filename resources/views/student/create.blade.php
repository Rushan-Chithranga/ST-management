<x-app-layout>
    <x-slot name="header">
        ...
        <h2 class="font-semibold text-xl text-black dark:text-gray-500 leading-tight">{{ __('Create Student') }}</h2>
    </x-slot>

    <div class="py-12 ">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex justify-center w-full">
            <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form class="space-y-6" action="{{ route('student-create') }}" method="POST">
                    @csrf
